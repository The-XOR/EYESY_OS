...
function draw()
    ...
    --Knob Jobs
    --knob 1 circle gain & moves the FBO left-right
	...
	of.fill()
	of.drawRectangle(knob1*1024,0,of.getWidth()/2,of.getHeight()) --only did half the screen on purpose! knob1 moves the FBO left & right
...
function box3()
    ...
    of.fill()
    --top line
    of.setColor(204,g,204)
    of.beginShape()
    for i=1,64 do
       of.vertex( (knob4*1024)+704+(i*8), 284 - inR[i]*gain)
    end

    --right line
    for i=1,64 do
        of.vertex( (knob4*1024)+1216+inR[64+i]*gain, 284+i*8)
    end
    
    --bottom line
    for i=1,64 do
        of.vertex( (knob4*1024)+1216-(i*8), 796 - inR[128+i]*gain)
    end

    --left line
    for i=1,64 do
        of.vertex( (knob4*1024)+704+inR[192+i]*gain, 796-i*8)
    end
    of.endShape()
