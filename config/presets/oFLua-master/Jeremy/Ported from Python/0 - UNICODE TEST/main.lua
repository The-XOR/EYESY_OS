...
--uni = of.Unicode()
--sett = of.TrueTypeFontSettings( "font.ttf", 65  )
--sett:addRange( of.Unicode:add(Arabic) )
font = of.TrueTypeFont()
--font.load( sett )

randomAscii = string.char( math.random(10, 128) ) .. string.char( math.random(10, 128) )
...
function draw()
    ...
    size =  math.floor( (knob2 * 100) + 5 )
    font:load( "font.ttf", size )
    -- the trigger --
    
    
    of.pushMatrix()
    
        font:drawString( "this is a char string", Width/2, Height/2) 
