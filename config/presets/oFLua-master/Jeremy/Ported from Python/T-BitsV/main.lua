...
ypos = {}
ypos1 = {}
ypos = xPs( -min10, Height, lineAmt )
ypos1 = dis( ypos, displace, lineAmt)
-- draw shadow lines--
function shadow( name, i)
    
    y = name[i] + lineLength
    x = ( i * lineW ) + ( (lineW/2) - 1 )
    of.drawLine( x + displace, name[i], x + displace, y )
