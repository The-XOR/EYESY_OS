...
----------------------------------------------------
function draw()
    FScol = glm.ceil(knob5*130+6)
    of.setBackgroundColorHex(colortable[FScol])
...
function Cscope()
    ...
    for i=1,lines do
        soundwidth = inL[i]* Width
        x0 = knob1*Width
        x1 = x0 + soundwidth
        y = i*space-space
        newy = Height*3/4-knob2*Height*3/2
        of.setHexColor(colortable[glm.ceil(knob4*130+i*.125)])
        of.drawLine(x0,y+i,x1,y+i+newy)
    end
end
----------------------------------------------------
function exit()
